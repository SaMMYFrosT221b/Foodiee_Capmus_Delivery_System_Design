    ...
    ;(async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_HOST_URL}/shopkeeper/catalogue/${shopID}`,
        )
              ...
              <CTableHead>
                <CTableRow>
                  <CTableHeaderCell scope="col">
                    <CIcon icon={icon.cilFastfood} size="sm" />
                    ItemName
                  </CTableHeaderCell>
                  ...
                  <CTableHeaderCell scope="col">
                    <CIcon icon={icon.cilAvTimer} size="sm" />
                    ExpectedTime
                  </CTableHeaderCell>
                  <CTableHeaderCell scope="col">
                    <CIcon icon={icon.cifIn} size="sm" />
                    CousineType
                  </CTableHeaderCell>
                </CTableRow>
              </CTableHead>
                  ...
                  return (
                    <CTableRow key={item.ItemID} color="secondary">
                      ...
                      <CTableDataCell>
                        ...
                        <CPopover title="Description" content={item.Description} placement="right">
                      ...
                      <CTableDataCell>
                        <CBadge color="dark">{item.ExpectedTime}</CBadge>
                      </CTableDataCell>
