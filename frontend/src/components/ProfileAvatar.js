...
import TabbedNavigations from "../components/TabbedNavigation/TabbedNavigations";
import FooterFromTailWind from "./FooterFromTailwind";
import UserHome from "../components/User/UserHome";
import OrderListing from "../components/User/OrderListing";
        ...
        <div className="w-full h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="space-x-4 mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                {Object.keys(pages).map((tabName) => (
                  <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 dark:border-strokedark sm:flex-row">
                    <button
                      className={`px-4 py-2 ${
                        activeTab === tabName
                          ? "bg-gray-500 text-white border rounded"
                          : "bg-white text-black"
                      }`}
